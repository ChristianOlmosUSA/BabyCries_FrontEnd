		...
		<div className="p-3 mt-3 flex-col container-fluid">
			...
			<div className="p-3 m-5 mt-3">
				...
				<ol className="m-3 p-2">
                    <li className="m-1 p-4">Detects whether the baby is face up or face down. Most international guidelines suggest young babies are kept face up​ to prevent SIDS.</li>
                    <li className="m-1 p-4">Identifies the breathing rate of the baby. The user gets default variables, and can also adjust these or disable the alert. But the great thing about these two functions is getting an alert to your phone by text message telling you if your baby has very rapid or slow breathing or has rolled onto their face​</li>
                    <li className="m-1 p-4">Cry Interpretation. Using an opensource database of 715 cries which have been categorized, we can also respond to the noise of crying whether it is ‘hunger’, ‘sleepiness’, ’boredom’, ’colicky’, ’sick’, or ’has had enough’ ​​</li>
                </ol>
			...
			<div className="container-fluid homePageLogo">
				<div className="d-flex flex-row flex-fill container-fluid">
					<img className="img-fluid m-3 p-3" src={RPi_Logo} />
					<img className="img-fluid m-3 p-3" src={TF_Logo} />
					<img className="img-fluid m-3 p-3" src={OpenCV_Logo} />
				</div>
			</div>
		</div>
	</div>
